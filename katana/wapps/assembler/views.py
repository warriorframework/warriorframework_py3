...
def check_repo_availability(request):
    ...
    if not check_url_is_a_valid_repo(url):
        ...
        temp_directory = os.path.join(nav_obj.get_katana_dir(), "katana.wapps", "assembler", ".data")
...
def save_warhorn_config_file(request):
    ...
    if directory == "default":
        directory = os.path.join(nav_obj.get_katana_dir(), "katana.wapps", "assembler", ".data")
