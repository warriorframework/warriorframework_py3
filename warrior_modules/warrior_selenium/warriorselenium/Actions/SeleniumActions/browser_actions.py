...
from warriorselenium.ClassUtils.WSelenium.browser_mgmt import BrowserManagement
from warriorselenium.Actions.SeleniumActions.verify_actions import verify_actions
from warriorselenium.Actions.SeleniumActions.elementlocator_actions import elementlocator_actions

from warrior.Framework import Utils
from warriorselenium.Utils import selenium_Utils
...
from warriorselenium.Utils.rest_Utils import remove_invalid_req_args
    ...
    def browser_launch(self, system_name, browser_name="all", type="firefox",
        ...
        for browser in browser_list:
            ...
            if browser_details is not None:
                ...
                # Need to pass the binary, gecko_path, proxy_ip, proxy_port
