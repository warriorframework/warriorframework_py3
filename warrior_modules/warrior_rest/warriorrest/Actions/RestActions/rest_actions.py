...
from warriorrest.Utils import rest_Utils
...
from warriorrest.ClassUtils.rest_utils_class import WRest
...
class RestActions(object):
    ...
    def perform_http_post(self, system_name, variable_config=None,
        ...
        ** dict-in-tuple pattern **
        ...
        credentials, popped_args = rest_Utils.\
    ...
    def verify_response(self, system_name, expected_api_response,
        ...
        generate_output_diff_file = rest_Utils.\
            resolve_value_of_verify(generate_output_diff_file)

        try:
            arguments["expected_api_response"] = rest_Utils.\
            ...
            credentials["expected_api_response"] = rest_Utils.\
