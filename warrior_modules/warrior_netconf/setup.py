...
setup(
    ...
    long_description= "netconf_driver package for warrior framework",
    ...
    install_requires=["lxml==4.4.1", "paramiko==2.10.1", "pycryptodome==3.6.1"]
