...
def test_execute_custom_parallel():
    ...
    multiprocessing_utils.create_and_start_process_with_queue = MagicMock(return_value=('val', [1,2], 'val'))
    ...
    warrior.Framework.Utils.testcase_Utils.append_result_files = MagicMock(return_value=None)
    # warrior.Framework.Utils.testcase_Utils = MagicMock(return_value=True)
    #Utils.testcase_Utils = MagicMock(return_value=None)
