        ...
        if boolprompt == 0:
            ...
            try:
                ...
                if self.target_host.after == self.pexpect.TIMEOUT:
                    ...
                    data_repository[
                        'step_%s_errormessage' % step_num] = "device unresponsive while executing command: {}".format(
                        command.split(":")[0])
                else:
                    try:
                        ...
                        data_repository[
                            'step_%s_errormessage' % step_num] = "Response decode error for command: {}".format(
                            command.split(":")[0])
                if kwargs.get("log", "true") != "false":
                    pNote("Response:\n{0}\n".format(response))
                pNote(msg, "debug")
