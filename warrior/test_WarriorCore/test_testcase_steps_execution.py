...
def test_execute_steps_with_step_and_parallel_true_and_skip_invoked_false():
    ...
    assert result == ([False, False], [[], []], ['impact', 'impact'], {'wt_filename':\
     'testcase_step_exe.xml', 'wt_logsdir': wt_logsdir, 'wt_def_on_error_action': 'NEXT',\
      'wt_def_on_error_value': '', 'wt_junit_object': None, 'step_num': 2, 'wt_driver':\
       'common_driver', 'wt_plugin': None, 'wt_keyword': 'wait_for_timeout', 'wt_step_impact':\
        'impact', 'wt_step_context': 'positive', 'wt_step_description':\
